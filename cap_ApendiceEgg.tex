\chapter{Simula\c{c}\~{o}es dos Po\c{c}os no Egg Model, Fase 1}
...
\chapter{Simula\c{c}\~{o}es dos Po\c{c}os no Egg Model, Fase 2}
...
\refstepcounter{noApendice}
\chapter{Simula\c{c}\~{o}es dos Po\c{c}os no Egg Model, Fase 3}
...
%TODO Fazer a fase 4!
\refstepcounter{noApendice}
\chapter{Simula\c{c}\~{o}es dos Po\c{c}os no Egg Model, Fase 4}
