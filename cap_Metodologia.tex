...
A história do estudo do SAIGUP está diretamente relacionada com os esforços da União Europeia em reduzir o tempo de produção do primeiro óleo e melhorar a eficiência de recuperação de hidrocarbonetos em geral, destacam Manzocchi \textit{et al.}; \cite{manzocchi2008sensitivity}
