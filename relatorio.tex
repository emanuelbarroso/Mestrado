...
\begin{fichacatalografica}
	...
	\begin{center}					% Minipage Centralizado
		\fbox{\begin{minipage}[c][6cm]{13.5cm}		% Largura
				\small
				Barroso Neto, Emanuel Pereira
				
				\hspace{0.5cm}{{Retrofitting do rob\^{o} ASEA IRB6-S2 baseado em tecnologias de comando num\'{e}rico usando LinuxCNC}  / \autorinome . --Brasil, 2018.}
